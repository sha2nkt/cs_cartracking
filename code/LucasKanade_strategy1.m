function [dp__star_x,dp_star_y] = LucasKanade_strategy1(I1, It1, rect, rect1)
...
%Template
T_rows = (floor(rect1(2)):floor(rect1(4)));
T_columns = (floor(rect1(1)):floor(rect1(3)));
[t_idx_x, t_idx_y] = meshgrid(T_columns,T_rows); 
T = interp2(I1,t_idx_x,t_idx_y); %Should apply W(p) after this but since p = 0 no need
%Initial guess
%Note: Rect already has pn 
